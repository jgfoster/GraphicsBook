...
if [ -e "web-site" ] ; then
   ...
   mv web-site graphicsbook-1.2-web-site
   zip -r graphicsbook-web-site.zip graphicsbook-1.2-web-site > /dev/null
   mv graphicsbook-web-site.zip downloads
   mv graphicsbook-1.2-web-site graphicsbook2018
   mv graphicsbook2018/news-for-web.html graphicsbook2018/news.html
fi
