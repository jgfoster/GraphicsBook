...
\exercise \marginpar{\small{\textit{\href{http://math.hws.edu/eck/cs424/graphicsbook2018/c<xsl:number count="chapter"/>/ex<xsl:number count="exercise"/>-ans.html}{\ \ \ (solution)}}}}\ignorespaces <xsl:apply-templates select="exercise-question"/>
</xsl:for-each> 
...
\begin{quiz}\marginpar{\small{\textit{\href{http://math.hws.edu/eck/cs424/graphicsbook2018/c<xsl:number count="chapter"/>/quiz_answers.html}{\ \ (answers)}}}}
...
<!-- 
<xsl:template match="start">\<xsl:value-of select="name()"/>{<xsl:apply-templates/>}<xsl:if test="ancestor::section">\marginpar{\small{\textit{\href{http://math.hws.edu/eck/cs424/graphicsbook2018/c<xsl:number count="chapter"/>/s<xsl:number count="section"/>.html }{\ \ \ (online)}}}}</xsl:if></xsl:template>
-->
...
<xsl:template match="sourceref"><xsl:variable name="a" select="str:new(@href)"/><xsl:variable name="b" select="str:replaceAll($a,'_','\\_')"/><xsl:choose>
   <xsl:when test="text()">\href{http://math.hws.edu/eck/cs424/graphicsbook2018/source/<xsl:value-of select="$b"/>}{<xsl:apply-templates/>}</xsl:when>
   <xsl:otherwise>\href{http://math.hws.edu/eck/cs424/graphicsbook2018/source/<xsl:value-of select="$b"/>}{<xsl:value-of select="$b"/>}</xsl:otherwise>
</xsl:choose></xsl:template>
...
<xsl:template match="demoref"><xsl:variable name="a" select="str:new(@href)"/><xsl:variable name="b" select="str:replaceAll($a,'_','\\_')"/><xsl:choose>
   <xsl:when test="text()">\href{http://math.hws.edu/eck/cs424/graphicsbook2018/demos/<xsl:value-of select="$b"/>}{<xsl:apply-templates/>}</xsl:when>
   <xsl:otherwise>\href{http://math.hws.edu/eck/cs424/graphicsbook2018/demos/<xsl:value-of select="$b"/>}{<xsl:value-of select="$b"/>}</xsl:otherwise>
</xsl:choose></xsl:template>
...
<xsl:template match="jarref"><xsl:variable name="a" select="str:new(@href)"/><xsl:variable name="b" select="str:replaceAll($a,'_','\\_')"/><xsl:choose>
   <xsl:when test="text()">\href{http://math.hws.edu/eck/cs424/graphicsbook2018/jars/c<xsl:number count="chapter"/>/<xsl:value-of select="$b"/>}{<xsl:apply-templates/>}</xsl:when>
   <xsl:otherwise>\href{http://math.hws.edu/eck/cs424/graphicsbook2018/jars/chapter<xsl:number count="chapter"/>/<xsl:value-of select="$b"/>}{<xsl:value-of select="$b"/>}</xsl:otherwise>
</xsl:choose></xsl:template>
...
<xsl:apply-templates/>
\marginpar{\textit{\href{http://math.hws.edu/eck/cs424/graphicsbook2018/demos/<xsl:value-of select="@src"/>}{\ \ \ (Demo)}}}
</xsl:template>
